 ...
 * @var \CoasterCommerce\Core\Model\Order\Shipping\AbstractShipping[] $methods
 */
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! $formBuilder->open(['route' => 'coaster-commerce.admin.system.shipping.save', 'files' => true]) !!}

                    <div class="row">

                        <h1 class="card-title col-sm-7 mb-5">Shipping Methods</h1>
                        ...
                        <div class="card mb-3 border-bottom">
                            <div class="card-header" id="{{ $method->code }}_head">
                                <h2 class="mb-0" data-toggle="collapse" data-target="#{{ $method->code }}_collapse" aria-expanded="true">
                                    <i class="fa fa-truck"></i> &nbsp; {{ $method->type() . ' - ' . $method->name }}
                                </h2>
                            </div>
                            ...
                            <div id="{{ $method->code }}_collapse" class="collapse" aria-labelledby="{{ $method->code }}_head">
                                <div class="card-body">
                                    ...
                                    @if ($method->showOrderRestrictions)
