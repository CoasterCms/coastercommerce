...
class CreateCcProductEavDecimal extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->_schema->create('cc_product_eav_decimal', function(Blueprint $table) {
            $table->increments('id');
    ...
    {
        $this->_schema->drop('cc_product_eav_decimal');
    }
