...
class CreateCcProductEavString extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->_schema->create('cc_product_eav_string', function(Blueprint $table) {
            $table->increments('id');
    ...
    {
        $this->_schema->drop('cc_product_eav_string');
    }
